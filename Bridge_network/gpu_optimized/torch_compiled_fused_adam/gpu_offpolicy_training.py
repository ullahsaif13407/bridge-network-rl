...
class OffPolicyConfig:
    ...
    mini_batch: int = 1024         # OPTIMIZED: Increased from 256
    ...
    lr_schedule_step_every: int = 1000           # step scheduler every N update() calls (staircase if >1) once annealing starts
    ...
    use_wandb: bool = True
    wandb_project: str = 'BridgeNetwork_GPU_OffPolicy'
...
class OffPolicyTrainer:
    ...
    def __init__(self, config: OffPolicyConfig):
        ...
        self.policy = BridgeNetworkActorCritic(shared_actor=False).to(self.device)
        ...
        for t in range(ep_len):
            ...
            with torch.no_grad():
                action_logits, values = self.policy(
                    ...
                    extra_state, ages.float(), time_ratio
                )
            ...
            self.buffer.push(
                belief, extra_state, ages, time_ratio, yt_ratio,
