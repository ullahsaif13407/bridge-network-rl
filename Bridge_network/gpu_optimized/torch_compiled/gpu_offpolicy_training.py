...
class OffPolicyConfig:
    ...
    lr_schedule_updates: Optional[int] = 1000   # if None, uses total_episodes // lr_schedule_step_every 
    lr_schedule_min_lr_ratio: float = 0.01      # final_lr = initial_lr * ratio (clamped)
    lr_schedule_step_every: int = 2000            # step scheduler every N update() calls (staircase if >1)
